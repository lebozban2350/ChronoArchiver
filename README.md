...
[![Version](https://img.shields.io/badge/version-4.5.9-blue.svg)](https://github.com/UnDadFeated/ChronoArchiver/releases)
...
Release **4.5.9** — installers and AUR `pkgver` are aligned on this version.

### GitHub (Windows / macOS installers)

Download from [**Releases**](https://github.com/UnDadFeated/ChronoArchiver/releases) (**tag `v4.5.9`**):

| Platform | Asset |
|----------|--------|
| Windows x64 | `ChronoArchiver-Setup-4.5.9-win64.exe` |
| macOS | `ChronoArchiver-Setup-4.5.9-mac64.zip` |
...
Package **[chronoarchiver](https://aur.archlinux.org/packages/chronoarchiver)** at **4.5.9**:
