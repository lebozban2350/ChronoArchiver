...
[![Version](https://img.shields.io/badge/version-3.8.8-blue.svg)](https://github.com/UnDadFeated/ChronoArchiver/releases)
...
Release **3.8.8** — installers and AUR `pkgver` are aligned on this version.

### GitHub (Windows / macOS installers)

Download from [**Releases**](https://github.com/UnDadFeated/ChronoArchiver/releases) (**tag `v3.8.8`**):

| Platform | Asset |
|----------|--------|
| Windows x64 | `ChronoArchiver-Setup-3.8.8-win64.exe` |
| macOS | `ChronoArchiver-Setup-3.8.8-mac64.zip` |
...
Package **[chronoarchiver](https://aur.archlinux.org/packages/chronoarchiver)** at **3.8.8**:
