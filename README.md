...
Release **3.8.3** — installers and AUR `pkgver` are aligned on this version.

### GitHub (Windows / macOS installers)

Download from [**Releases**](https://github.com/UnDadFeated/ChronoArchiver/releases) (**tag `v3.8.3`**):

| Platform | Asset |
|----------|--------|
| Windows x64 | `ChronoArchiver-Setup-3.8.3-win64.exe` |
| macOS | `ChronoArchiver-Setup-3.8.3-mac64.zip` |
